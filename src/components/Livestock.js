...
const livestock = () => {
  const farmDetails = {
    ...
    name:"Asili Farm",
    about:
      "Welcome to Asili Farm! We specialize in raising healthy and happy cow. Our mission is to provide the community with fresh and high-quality cattle products.",
    typeOfFarming: "Free-Range cattle Farming",
    farmingDescription:
      "Free-range cattle farming allows our cattle to roam freely outdoors, ensuring they have access to natural sunlight and fresh air. We prioritize their well-being and follow sustainable practices in livesock farming.",
    farmerInfo: {
      name: " Tom Cassara",
      experience: "30 years in livestock Farming",
      background:
        "With a passion for livingstock farming, Tom has decades of experience in raising cows. He is committed to delivering top-notch cattle products to the local community.",
      photo:
